...
/**
 * Clase principal de la aplicación para el bot de Discord ApoloBOT. Esta clase sirve como punto de
 * entrada para la aplicación Spring Boot. Inicializa el contexto de Spring y arranca el bot de
 * Discord.
 *
 * <p>La aplicación utiliza MongoDB para la persistencia de datos, que se habilita a través de la
 * anotación @EnableMongoRepositories.
 *
 * @author roca12
 * @version 2025-I
 */
