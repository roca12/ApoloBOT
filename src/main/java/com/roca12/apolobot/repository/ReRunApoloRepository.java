...
/**
 * Interfaz de repositorio para acceder a entidades ReRunApolo en MongoDB.
 * Esta interfaz proporciona métodos para recuperar registros de reinicio del bot
 * y contar el número total de eventos de reinicio.
 * 
...
public interface ReRunApoloRepository extends MongoRepository<ReRunApolo, String> {
   ...
   * @return Un Optional que contiene la entidad ReRunApolo coincidente, o vacío si no se encuentra ninguna
   */
