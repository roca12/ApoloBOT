...
/**
 * Interfaz de repositorio para acceder a entidades de Training en MongoDB. Esta interfaz
 * proporciona métodos para encontrar sesiones de entrenamiento por fecha/hora y para encontrar
 * próximas sesiones de entrenamiento que han sido o no anunciadas.
 *
...
public interface TrainingRepository extends MongoRepository<Training, String> {
  ...
  /**
   * Encuentra sesiones de entrenamiento dentro de un rango de fecha/hora con un estado de anuncio
   * específico. Este método se utiliza para encontrar próximas sesiones de entrenamiento que han
   * sido o no anunciadas.
   *
   * @param startDateTime El inicio del rango de fecha/hora
   * @param endDateTime El fin del rango de fecha/hora
   * @param announced Si se deben encontrar sesiones de entrenamiento anunciadas (true) o no
   *     anunciadas (false)
