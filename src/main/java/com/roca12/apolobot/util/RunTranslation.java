...
/**
 * Utility class to run the Javadoc translation process.
 * This class simply calls the main method of TranslateDocumentation
 * to translate all Javadoc comments in the project from English to Spanish.
 * 
 * @author roca12
 * @version 2025-I
 */
