...
/**
 * Utility class for translating text from English to Spanish. This class uses the Google Cloud
 * Translation API to perform translations. It is primarily used for translating documentation
...
public class TranslationUtil {
  ...
  static {
    ...
    try {
      ...
      translate = TranslateOptions.newBuilder().setApiKey(traductorApiKey).build().getService();
    } catch (IOException e) {
  ...
  /**
   * Translates a Javadoc comment from English to Spanish. This method preserves the Javadoc format
   * while translating the content.
   *
