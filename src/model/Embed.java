...
public class Embed {
	...
	public Embed(String title, String description, User author, ArrayList<String> fields,
			ArrayList<String> inLineFields, String color, String footer, String image, String thumbnail) {
		super();
		this.title = title;
